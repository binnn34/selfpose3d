...
# 저장 경로
save_path = "D:/SelfPose3d/pseudo_labels/pseudo_bboxes_3images_detection.json"
os.makedirs(os.path.dirname(save_path), exist_ok=True)

with open(save_path, 'w') as f:
    json.dump(detection_json, f, indent=2)

print("✅ Detection용 JSON 생성 완료:", save_path)

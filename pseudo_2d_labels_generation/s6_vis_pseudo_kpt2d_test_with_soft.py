...
random.seed(0)
GT_FILE = os.path.join(ROOT_PATH, "pseudo_labels", "s5_pseudo_kpt2d_dance1_with_soft.json")
IMGDIR = os.path.join(ROOT_PATH, "frames")
OUTPUT_DIR = os.path.join(ROOT_PATH, "pseudo_labels", "kpt2d_hrnet", "dance1", "vis_soft")

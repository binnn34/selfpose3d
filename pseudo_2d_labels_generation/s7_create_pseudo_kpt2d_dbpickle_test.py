...
PSEUDO_GT_JSON = os.path.join(ROOT_PATH, "pseudo_labels", "s5_pseudo_kpt2d_dance1.json")
TRAIN_DB_PATH = os.path.join(ROOT_PATH, "pseudo_labels", "kpt2d_hrnet", "group_dance1_train_sub.pkl")
OUT_PATH_HRNET_HARD = os.path.join(ROOT_PATH, "pseudo_labels", "kpt2d_hrnet", "group_pseudo_dance1_hard.pkl")
OUT_PATH_HRNET_SOFT = os.path.join(ROOT_PATH, "pseudo_labels", "kpt2d_hrnet", "group_pseudo_dance1_soft.pkl")
...
def main():
    ...
    for ds in tqdm(gt_data["db"]):
        ...
        for ann in pseudo_anns:
            ...
            joints_2d_soft, joints_2d_vis_soft = coco2panoptic(ann["keypoints"], mapping)
